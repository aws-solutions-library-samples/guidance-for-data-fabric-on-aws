...
export const dataAssetApiUrlParameter = `/sdf/dataAsset/apiUrl`;
export const dataAssetFunctionNameParameter = `/sdf/dataAsset/functionName`;
export const dataAssetTableNameParameter = `/sdf/dataAsset/tableName`;
export const dataAssetTableArnParameter = `/sdf/dataAsset/tableArn`;
export const dataAssetStateMachineArnParameter = `/sdf/dataAsset/stateMachineArn`;
...
export class DataAssetStack extends Stack {
    constructor(scope: Construct, id: string, props: DataAssetStackProperties) {
        ...
        //     true);
            ...
            //     {
            //         id: 'AwsSolutions-IAM5',
            //         appliesTo: ['Resource::*','Resource::arn:aws:states:<AWS::Region>:<AWS::AccountId>:execution:sdf-dataAsset:*'],
            //         reason: 'This policy attached to the role is generated by CDK.'
            //     },
            //     {
            //         id: 'AwsSolutions-IAM4',
