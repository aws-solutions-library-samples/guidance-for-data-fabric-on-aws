...
export class SsoCustomStack extends Stack {
  constructor(scope: Construct, id: string, props: SsoCustomStackProperties) {
      ...
      [
        {
          ...
          appliesTo: ["Resource::*"],
          reason:
            "This resource condition in the IAM policy is generated by CDK, this only applies to logs:DeleteRetentionPolicy and logs:PutRetentionPolicy actions.",
        },
      ],
      true
    );
    ...
    NagSuppressions.addResourceSuppressionsByPath(
      this,
      [
        "/SsoCustomStack/SsoSeeder/CustomResourceProvider/framework-onEvent/Resource",
        
      ],
      [
        {
          id: "AwsSolutions-L1",
          reason: "Does not need the latest runtime version.",
        },
      ],
      true
    );
