...
export interface SsoApplicationSeederConstructProperties {
	environment: string;
}

export const ssoApplicationNameParameter = (environment: string) => `/sdf/${environment}/shared/ssoApplicationName`;
export const ssoApplicationArnParameter = (environment: string) => `/sdf/${environment}/shared/ssoApplicationArnParameter`;
export const ssoApplicationMetadataUrlParameter = (environment: string) => `/sdf/${environment}/shared/ssoApplicationMetadataUrlParameter`;



export class SsoApplicationSeeder extends Construct {

	public tenantSecret: DatabaseSecret;
	public tenantDatabaseUsername: string;

	constructor(scope: Construct, id: string, props: SsoApplicationSeederConstructProperties) {
		super(scope, id);
