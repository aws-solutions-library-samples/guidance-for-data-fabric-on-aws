...
import postCredentialsRoute from "./credentials/post.handler.js";
import { credentialsResource } from "./credentials/schemas.js";
...
export const buildApp = async (): Promise<FastifyInstance> => {
	...
	app.addSchema(credentialsResource);
	await app.register(postCredentialsRoute);
