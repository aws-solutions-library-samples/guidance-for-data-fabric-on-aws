...
export class DataQualityProfileJobTask {
    ...
    public async process(event: DataAssetTask): Promise<any> {
        ...
        const rulesetName = `df-createDataQualityProfile-${id}`;
        ...
        const rulesetArn = `arn:aws:glue:${executionMetadata[3]}:${executionMetadata[4]}:dataQualityRuleset/${rulesetName}`;
        ...
        event.dataAsset.lineage.dataQualityProfile = this.constructDataLineage(event, startDataQualityRulesetEvaluationResponse.RunId, rulesetArn);
    ...
    private constructDataLineage(event: DataAssetTask, runId: string, rulesetArn: string): Partial<RunEvent> {
        this.log.info(`DataQualityProfileJobTask > constructDataLineage > in> event: ${event}, runId: ${runId}, rulesetArn: ${rulesetArn}`);
        ...
        openlineageBuilder
            .setContext(catalog.domainId, catalog.domainName, rulesetArn)
            .setJob(
                {
