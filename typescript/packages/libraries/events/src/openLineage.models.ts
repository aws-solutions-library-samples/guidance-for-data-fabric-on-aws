...
export const ACCESS_CONTROL_EVENT_SOURCE: string = 'com.aws.df.accessControl';
export const DATA_LINEAGE_EVENT_SOURCE: string = 'com.aws.df.dataLineage';
export const DATA_ASSET_EVENT_SOURCE: string = 'com.aws.df.dataAsset';

export const DATA_LINEAGE_DIRECT_INGESTION_REQUEST_EVENT = `DF>${DATA_LINEAGE_EVENT_SOURCE}>ingestion>request`;
